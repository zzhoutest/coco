...
var handle_reply_select_test_carousel = function(message) {
  ssbot.read(message.RCSMessage.msgId, onResponse);
  ssbot.typing(message.messageContact, "active", onResponse);
  ...
  if (pb == postbacks.test_carousel_learn) {
    ...
    var content = ssbot.newGeneralCarouselContent(c1, c2, c3, c4, c5, c6, c7, c8);//, c3, c4, c5, c6, c7, c8);
...
ssbot.handle(['reply_learnmore_carousel','reply_full_carousel','reply_back_to_carousel_10776'], 'postback', handle_reply_select_test_carousel);
